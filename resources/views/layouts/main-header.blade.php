							...
							<div class="dropdown nav-item main-header-notification">
								...
								<div class="dropdown-menu">
									<div class="menu-header-content bg-primary text-right">
										<div class="d-flex">
											...
											<span class="badge badge-pill badge-warning mr-auto my-auto float-left">
												<a href = "markAsRead">قراء الكل</a>
											</span>
										</div>
										<div id = "unreadnotificationCount">
									...
									@foreach(auth()->user()->unreadNotifications as $notification)
										<a class="d-flex p-3 border-bottom" href="{{url('InvoicesDetails_WithRead')}}/{{$notification->data['invoice_id']}}">
											<div class="notifyimg bg-primary">
												<i class="la la-check-circle text-white"></i>
											</div>
											<div class="mr-3">
												<h5 class="notification-label mb-1">{{$notification->data['title']}} من قبل {{$notification->data['userCreate']}}</h5>
