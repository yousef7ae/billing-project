				...
				<ul class="side-menu">
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							...
							<li><a class="slide-item" href="{{ url('unpaid_Invoices') }}">الفواتير الغير مدفوعة</a></li>
							@endcan

							@can('الفواتير المدفوعة جزئيا')
							<li><a class="slide-item" href="{{ url('partially_Paid_Invoices') }}">الفواتير المدفوعة جزئيا</a></li>
							@endcan
					...
					@can('التقارير')
					<li class="side-item side-item-category"><h5>التقارير</h5></li>
					<li class="slide">
						...
						@can('تقرير العملاء')
							<li><a class="slide-item" href="{{ url('/' . $page='report_customer') }}">تقارير العملاء</a></li>
						@endcan	
						</ul>
					</li>
					...
					@can('المستخدمين')
					<li class="side-item side-item-category"><h5>المستخدمين</h5></li>
                    ...
                    @can('الاعدادات')
					<li class="side-item side-item-category"><h5>الاعدادات</h5></li>
