                ...
                <form action="{{ route('status_update' ,[ $invoice->id])  }}" method="post" enctype="multipart/form-data"
                        ...
                        <div class="col">
                            ...
                            <div class="col">
                                ...
                                <select id="product" name="product" value = "" class="form-control" readonly>
                            ...
                            <div class="col">
                                ...
                                <input type="text" class="form-control" id="inputName" name="Amount_collection"
                                   value = "{{$invoice->amount_collection}}" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" readonly>
                            </div>
                        </div>
