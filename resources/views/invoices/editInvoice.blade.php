                ...
                <form action="{{ route('invoice.update') }}" method="post" enctype="multipart/form-data"
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <input class="form-control fc-datepicker" name="invoice_Date" value = "{{$invoice->invoice_date}}" placeholder="YYYY-MM-DD"
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <select id="product" name="product" value = "" class="form-control">
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <select value = "{{$invoice->rate_vat}}" name="Rate_VAT" id="Rate_VAT" class="form-control" onchange="myFunction()">
                                    <!--placeholder-->
