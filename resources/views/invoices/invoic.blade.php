            ...
            <div class="card mg-b-20">
                <div class="card-header pb-0">
                      ...
                      @endcan  
                        ...
                        @can('تصدير EXCEL')
                        <a class="modal-effect btn btn-sm btn-primary" href="{{ url('invoicesExport') }}"
                                                ...
                                                <div class="dropdown-menu tx-13">
                                                        ...
                                                        <a class="dropdown-item"
                                                            href="{{URL::route('show_status', [$invoice->id])}}"> <i
                                                                class=" text-success fas></i>                                                                                                                                                                                                                                                                                                                                                                                                                                                              l"><غير
                                                           حالة
                                                            الدفع </a>
                                                        @endcan    
                                                        ...
                                                        @can('طباعة الفاتورة')
                                                        <a class="dropdown-item" href="{{URL::route('print_Invoice', [$invoice->id])}}"><i
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <input type="hidden" name="id_page" id="page_num" value="1">
                </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <input type="hidden" name="invoice_id" id="invoice_id" value="">
                    <input type="hidden" name="id_page" id="page_num" value="0">
